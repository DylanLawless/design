---
title: Clinical and regulated data infrastructure
layout: page_wide
description: Clinical data infrastructure, regulated biomedical workflows, secure systems, governance, traceability, and translational evidence profile for Dylan Lawless
permalink: "/profiles/clinical-data-infrastructure/"
---
...
<div class="profile-metrics">
  <div class="profile-metric">
    <strong>>1,000</strong>
    <span>patients in secure clinical genomic, multi-omic, and EHR-linked workflows</span>
  </div>

  <div class="profile-metric">
    <strong>>100 TB</strong>
    <span>biomedical data managed through traceable analytical infrastructure</span>
  </div>

  <div class="profile-metric">
    <strong>>10</strong>
    <span>hospitals connected through multi-institutional clinical research programmes</span>
  </div>

  <div class="profile-metric">
    <strong>>CHF 6M</strong>
    <span>in combined national funding programmes</span>
  </div>
</div>
...
<div class="profile-grid">
  ...
  <div class="profile-card">
    <h3>Analytical reproducibility</h3>
    <p>
...
- [Genomic Vault](https://genomicvault.switzerlandomics.ch): long-term custody and controlled access for genomics and precision medicine.
